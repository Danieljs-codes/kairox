...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				'group/calendar bg-background in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent p-3 [--cell-size:--spacing(9)]',
			...
			classNames={{
				...
				week: cn('mt-1.5 flex w-full gap-x-0.5', defaultClassNames.week),
